...
class AppColors{
  static final Color textColor = const Color(0XFF6c211c);

  static final Color mainColor = const Color(0XFFee7017);
  static final Color smurfColor = const Color(0XFF6c211c);

  static final Color mainBlackColor = const Color(0XFF191919);
